<?php
/**
 * Template Name: Diary Entry 7 Template
 *
...
<head>
    ...
    <title>Diary Entry#7 The Sting</title>
...
normal">&nbsp;</b>&nbsp;&nbsp;&nbsp;<b style="mso-bidi-font-weight: normal"> </b>Why
    ...
    <p class="MsoNormal" style="text-indent:.5in" align="left">
        <font face="Arial">Strangely enough, I
            ...
            we landed in Normandy for the invasion, spelled by the combat “K” rations.
            An important part of this food memorabilia is due to the fault of one Staff
    ...
    <p class="MsoNormal" style="text-indent:.5in" align="left">
        <font face="Arial">Sergeant Speirs
            ...
            and Harold Zappendorf of Chicago. We stuck close to them in bivouac areas for
            they had a power generator on a trailer they towed and that gave us needed
            electric power when necessary. In addition, together we were the only enlisted
            Signalmen assigned to CCA Headquarters. Misery loves company. We all had become
            accustomed to the K and C rations long before we had the luxury and experience
            of dining on the new 10 in one rations; or when in a static position the field
    ...
    <p class="MsoNormal" style="text-indent:.5in" align="left">
        <font face="Arial">When the division had
            ...
            lemon powder to the unsuspecting Sergeant Speirs. Perhaps it was boredom or else
            hunger pains that motivated me to swap a case of unopened Cs off the side of
            Speirs half-track for a case of “duds” of hash &amp; lemon powder. I
            collected all the hash &amp; lemon cans I could find in our two wire vehicles
            and packed them into an empty C ration box. I then carefully re-nailed the
            boards back on top and then re-wired the retaining wire to where you could not
            easily tell it had been repacked with the “duds.” Making sure I wasn’t
            seen, I then swapped this bogus case for a virgin box stored in the rail on the
            side of Speirs half-track. I figured it would take the “dit-da-dit” crew a
            few days to come across the switched box of Cs. However, that very same day one
            of the crew selected <i style="mso-bidi-font-style:normal">that box</i> among
    ...
    <p class="MsoNormal" style="text-indent:.5in" align="left">
        <font face="Arial">With common knowledge
            ...
            Yankee would pull such a stunt.” With that Speirs gaze fell on Veno from
    ...
    <p class="MsoNormal" style="text-indent:.5in" align="left">
        <font face="Arial">Later when cooler
            ...
            So when soldiers of yesteryear start reminiscing about Army Chow and its
            shortcomings, I will always recall my Sting of the rebel sergeant and swapping
