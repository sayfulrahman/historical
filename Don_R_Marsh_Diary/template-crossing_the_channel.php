<?php
/**
 * Template Name: Crossing The Channel Template
 *
...
<div>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">When our vehicles were fully
        ...
        explosives in areas of suspect. Not a very comforting thought to those of us
        locked down below inside the iron coffin. One torpedo into that tub and we
        would sink to the bottom as other unfortunates had suffered; including a 2<sup>nd</sup>
        Armored Division LST attempting to land in the Sicily Invasion, in July 1943,
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">A sudden jolt shook me from
        ...
        Master’s signal lamps which guided the ship on to the shoreline. There
        wasn’t any sandy beach visible where we beached, but it didn’t matter. We
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">The night time hours dragged
        ...
        misses would rock the ship and we knew they were not finished bombing for the
        night, as others followed with their bomb runs. The ships anti-aircraft guns
        hammered throughout the night with the empty brass shell casings from the
        Bofors’ guns landing “plink-plink” on the steel decking of our LST. That
        is when the adrenaline began flowing! Orders were to remain in place and
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">Veno eased the jeep down the
        ...
        the starter. The water-proofing did not hold and there we sat. But, not for
        long. The Beach Master had a huge caterpillar tractor on standby for just such
        a malfunction. The Cat operator snagged a chain on to the front bumper and
