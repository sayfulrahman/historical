...
<head>
    ...
    <title>Diary Entry#16 &quot;Homeward Bound&quot;</title>
    <meta name="Microsoft Border" content="none, default">
</head>

<body stylesrc="../index.html">
    <h1 style="MARGIN: 0in 0in 0pt">
        <font size="3" face="Arial">DIARY ENTRY #16</font>
    </h1>
    ...
    <h1 style="MARGIN: 0in 0in 0pt">
        <font face="Arial">HOMEWARD BOUND</font>
    </h1>
    <h4 style="MARGIN: 0in 0in 0pt"><em>
    ...
    <p class="MsoFooter" style="MARGIN: 0in 0in 0pt; tab-stops: .5in">
        <font face="Arial">10
            September 1945</font>
    </p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">Larry
            ...
            area. There are two located in <st1:country-region w:st="on">
                <st1:place w:st="on">
                    France</st1:place>
            </st1:country-region>
            . One is at <st1:City w:st="on">
                <st1:place w:st="on">
                    Marseilles</st1:place>
            </st1:City>
            and the other at LeHavre. The anticipation and wait will soon be over as fast
            as the boat will take us home. As the truck crossed the French border headed
            south, by reading the road signs I knew <st1:place w:st="on">
                <st1:City w:st="on">
                    Marseilles</st1:City>
            </st1:place>
            would be my destination - unfortunately as it developed.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">Our
            ...
            assigned to the 102<sup>nd</sup>
            <st1:place w:st="on">
                <st1:PlaceName w:st="on">
                    Evacuation</st1:PlaceName>
                <st1:PlaceType w:st="on">
                    Hospital</st1:PlaceType>
            </st1:place>
            . Fifteen years later in <st1:country-region w:st="on">
                <st1:place w:st="on">
                    Korea</st1:place>
            </st1:country-region>
            it would be redefined as a “MASH” unit for field surgeries. Now it was just
            a shell, without any nurses, but still staffed by the male medical officers who
            would be our superiors on the ship to the <st1:country-region w:st="on">
                <st1:place w:st="on">
                    USA</st1:place>
            </st1:country-region>
            .
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">Most
            ...
            German marks and told them to spend it as they pleased when they got to <st1:country-region w:st="on">
                <st1:place w:st="on">
                    Germany</st1:place>
            </st1:country-region>
            . It was our “going away” present.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">The
            ...
            determine that the <st1:place w:st="on">
                <st1:City w:st="on">
                    Spreewerk Metallwaren</st1:City>
                , <st1:State w:st="on">
                    Berlin</st1:State>
            </st1:place>
            , made my pistol in 1941. To preclude the danger of having it stolen, during the
            ...
            friend to keep an eye on it and my wallet. GIs are known to steal things.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">The
            ...
            wooden structures designed to hold our metal helmets to use as washbasins. The <st1:place w:st="on">
                <st1:PlaceType w:st="on">
                    Camp</st1:PlaceType>
                <st1:PlaceName w:st="on">
                    Commander</st1:PlaceName>
            </st1:place>
            , a bull Colonel, put the word out that if the fires continued he would lock the
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial"><span style="mso-spacerun: yes">&nbsp;</span>By
            ...
            from a boat shipment served to enforce the abstinence rule.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">The
            ...
            capacity to haul us down to the docks. As we drove through the city of <st1:City w:st="on">
                <st1:place w:st="on">
                    Marseilles</st1:place>
            </st1:City>
            , a young teenage punk who appeared to be one of the thousands of Moroccan
            ...
            unwanted part of his world behind, but he had to remain. Ungrateful bastards. If
            <st1:country-region w:st="on">
                France</st1:country-region>
            needed an enema, they could insert the tube right there in <st1:place w:st="on">
                <st1:City w:st="on">
                    Marseilles</st1:City>
            </st1:place>
            .
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">We
            ...
            could not believe my eyes - another God damn <st1:City w:st="on">
                <st1:place w:st="on">
                    Liberty</st1:place>
            </st1:City>
            ship with the name of Charles Goodyear. My recollection of shipping out of
            Brooklyn in 1943 on another <st1:City w:st="on">
                <st1:place w:st="on">
                    Liberty</st1:place>
            </st1:City>
            ship, the George Sharswood, brought back grim memories. This ship was the same
            ...
            EC2-S-C1. It was built in the Oregon Shipping Corporation - Kaiser Boatyards at <st1:place w:st="on">
                <st1:City w:st="on">
                    Vancouver</st1:City>
                , <st1:State w:st="on">
                    Washington</st1:State>
            </st1:place>
            on hull #0587. It was designed to hold 550 troops with 5-tier rows of bunks. It
            was also used to carry German prisoners to the <st1:country-region w:st="on">
                <st1:place w:st="on">
                    USA</st1:place>
            </st1:country-region>
            - only in numbers totaling 308 prisoners. Indicating the POWs had more
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">The
            ...
            out into the <st1:place w:st="on">
                Mediterranean Sea</st1:place>
            for the Straits of Gibraltar and the open sea. The ship had to pause to take on
            ...
            and likely the speed was closer to 5 knots per hour.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">I
            ...
            and I had changed. <span style="mso-spacerun: yes">&nbsp;</span>At the same
            ...
            home you once knew no longer exists - physically or mentally.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">Lingering
            in the back of my mind, I had a “slight problem” I would have to deal with
            ...
            not prove to be too difficult for either of us, as it developed.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">There
            was a lot of uncertainty I had to reconcile at the appropriate time. I set it
            ...
            what would become a life long problem-solver - “Take ‘em one at a time.”</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">Sixteen
            days after we departed <st1:country-region w:st="on">
                France</st1:country-region>
            we pulled into the <st1:City w:st="on">
                <st1:place w:st="on">
                    Boston</st1:place>
            </st1:City>
            harbor on November 21<sup>st</sup> - two days shorter than my trip going
            overseas. Trucks met us at the dock and transported us to <st1:place w:st="on">
                <st1:City w:st="on">
                    Fort Devens</st1:City>
                , <st1:State w:st="on">
                    Massachusetts</st1:State>
            </st1:place>
            for processing. The first night on post we were treated to a steak dinner
            ...
            and wouldnn’t be for several years.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">On
            ...
            taken for granted that I had missed.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-ALIGN: center" align="center"><b
            style="mso-bidi-font-weight: normal">
            <font face="Arial">
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">We
            arrived in <st1:City w:st="on">
                Chicago</st1:City>
            the next morning, the 24th and later at the military depot adjoining <st1:place w:st="on">
                <st1:City w:st="on">
                    Fort Sheridan</st1:City>
                , <st1:State w:st="on">
                    Illinois</st1:State>
            </st1:place>
            . The same place I had enlisted at three years prior. It was cold with snow on
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in">
        <font face="Arial">Other
            ...
            and began my return to civilian life once more.</font>
    </p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt">
        <font face="Arial">
            <o:p>
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-ALIGN: center" align="center"><i
            ...
            <font face="Arial">Adios
                amigos. It has been one helluva experience of life.<o:p>
                </o:p>
            </font>
        </i></p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-ALIGN: center" align="center"><b
            style="mso-bidi-font-weight: normal"><i style="mso-bidi-font-style: normal">
                <font face="Arial">Mister
                    Don R. Marsh<o:p>
                    </o:p>
                </font>
            </i></b></p>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt"><i style="mso-bidi-font-style: normal">
            <font face="Arial">
                <o:p>
                    &nbsp;</o:p>
            </font>
    ...
    <h3 style="MARGIN: 0in 0in 0pt; LINE-HEIGHT: normal"><em>
            <font size="2" face="Arial">Publication
                or reproduction, in part or whole, is prohibited without written</font>
        </em></h3>
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in; TEXT-ALIGN: center" align="center"><span
    ...
    <p class="MsoNormal" style="MARGIN: 0in 0in 0pt; TEXT-INDENT: 0.5in; TEXT-ALIGN: center" align="center"><i><span
